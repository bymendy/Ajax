...
// 03 - lesoptions devront contenir les noms et prénoms affichés et l'id_employes dansla value
...
// Autre façon d'écrire plus lisible pour se connecter à la bdd
...
$liste_employes = $pdo->query(" SELECT * FROM employes ORDER BY prenom, nom ASC ");
        ...
        document.getElementById('choix').addEventListener('change', function () {
            ...
            xhttp.onreadystatechange = function () {
                ...
                if(xhttp.status == 200 && xhttp.readyState == 4) {
                    ...
                    // on transforme a réponse en véritable objet JSON
